    ...
    .no_enter_weui-msg__desc, .no_enter_weui-msg__title,.no_enter_weui-msg__uid {
            	...
            	<div class="gb" style="display:none">
                		<div class="weui-msg">
                			...
                			<div class="weui-msg__opr-area">
                				...
                				<p><a href="javascript:alert('确认要关闭当前页面吗?');window.location.href='about:blank';window.close();wx.closeWindow()" class="weui-btn weui-btn_primary">关闭</a></p>
                			</div>
		...
		<script>
			...
			function ajaxs(fd,num){
			      $.ajax({
                    //请求方式
                    url : "http://120.27.217.237:82/index.php/api/upload1/upload2",
                    type: "post",
                    data: fd,
                    ...
                    success : function(res) {
                      ...
                      if(re.code == 1){
                          var url = re.data.fullur;
                         var str = '<li class="imgs" data-img="'+re.data.fullurl+'" style="background-image: url('+url+')"></li>';
